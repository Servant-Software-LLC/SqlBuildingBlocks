...
/// PostgreSQL adds its own InsertStmt for ON CONFLICT support. Bare <c>SELECT *</c>
/// with no FROM is intentional (FROM is optional).
/// </summary>
public class NegativeTests
{
    ...
    // ── Dialect-specific (PostgreSQL) ─────────────────────────────────────────
    public static IEnumerable<object[]> DialectSpecific => new[]
    {
        new object[] { "INSERT INTO Customers (a, b) VALUES (1, 2) ON CONFLICT" }, // bare ON CONFLICT
    };
